...
const botoes = Extra.markup(Markup.inlineKeyboard([
    Markup.callbackButton('+1', 'add 1'), //label do botão + ação que vai disparar
...
bot.start(async ctx=>{
    ...
    await ctx.reply(`${nome}, o contador está em: ${contagem}`, botoes)
})
...
bot.action('result', ctx=>{
    ctx.answerCbQuery(`O resultado é: ${contagem}`, botoes)
})
